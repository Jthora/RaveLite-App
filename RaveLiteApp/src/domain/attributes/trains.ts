...
const EXERCISE_ATTRS: Record<string, Pair> = {
  ...
  'fire.side-kick': ['agility', 'power'],
  'fire.back-kick': ['agility', 'power'],
  'fire.hook-kick': ['agility', 'mobility'],
  'fire.axe-kick': ['agility', 'mobility'],
  'fire.crescent-kick': ['agility', 'mobility'],
  'fire.knee-strike': ['power', 'stamina'],
  'fire.spin-turn-drill': ['balance', 'agility'],
  'fire.kick-combo': ['agility', 'power'],
  'fire.jab-cross': ['speed', 'stamina'],
  'fire.hook-uppercut': ['speed', 'power'],
  'fire.elbow-strikes': ['power', 'speed'],
  'fire.block-drill': ['awareness', 'agility'],
  'fire.parry-slip': ['awareness', 'agility'],
  'fire.combo-flow': ['agility', 'stamina'],
  'fire.tuck-jump': ['power', 'agility'],
  'fire.skater-bound': ['power', 'balance'],
  'fire.pogo-hops': ['agility', 'power'],
  'fire.vertical-jump': ['power'],
  'earth.stance-transitions': ['toughness', 'balance'],
  'earth.hollow-rock': ['toughness', 'strength'],
  'earth.rkc-plank': ['toughness'],
  'earth.copenhagen-plank': ['toughness', 'mobility'],
  'earth.bird-dog': ['toughness', 'balance'],
  'earth.suitcase-carry': ['toughness', 'strength'],
  ...
  'earth.chair-pose': ['toughness', 'strength'],
  'earth.tree-pose': ['balance', 'mobility'],
  'earth.crow-progression': ['balance', 'strength'],
  'water.body-isolations': ['dexterity', 'presence'],
  'water.body-wave': ['dexterity', 'mobility'],
  'water.arm-wave': ['dexterity'],
  'water.two-step': ['agility', 'dexterity'],
  'water.grapevine': ['agility', 'dexterity'],
  'water.toprock': ['agility', 'dexterity'],
  'water.house-jack': ['agility', 'dexterity'],
  'water.spin-spotting': ['balance', 'agility'],
  'water.freeze-hold': ['toughness', 'balance'],
  'water.groove-combo': ['agility', 'presence'],
  'water.sun-salutation': ['mobility', 'breath'],
  'water.down-dog-cobra': ['mobility'],
  'water.cloud-hands': ['balance', 'dexterity'],
  'water.brush-knee': ['balance', 'dexterity'],
  'water.grasp-sparrows-tail': ['dexterity', 'balance'],
  'water.tai-chi-walk': ['balance', 'recovery'],
  'heart.standing-post': ['focus', 'toughness'],
  'heart.flow-performance': ['presence', 'dexterity'],
