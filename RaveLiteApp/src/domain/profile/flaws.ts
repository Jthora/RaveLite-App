...
export const FLAWS: readonly Flaw[] = [
  {
    ...
    element: 'air',
    what: 'Head forward of your shoulders, shoulders rolled in, chest short and the muscles between your shoulder blades asleep.',
    cause: 'Years of looking down and slightly forward at something bright.',
    costs:
      'It closes the chest, which shortens the breath — and a shortened breath is a shorter night on the floor.',
    target: 'UCS',
    times: 24,
    withinDays: 28,
    tell: 'Stand against a wall. If the back of your head does not reach it without you lifting your chin, this is yours.',
  },
  {
    id: 'APT',
    name: 'Tipped Pelvis',
    ...
    element: 'earth',
    what: 'The front of your pelvis rotated down, lower back over-arched, hip flexors short and the glutes not firing when they should.',
    cause:
      'Sitting. The hips spend the day folded, and the body takes the hint.',
    costs:
      'It steals power from every kick and jump, because the glutes never get to be the thing that moves you.',
    target: 'APT',
    times: 24,
    withinDays: 28,
    tell: 'Lie flat. If you can slide a whole forearm under your lower back, this is yours.',
  },
  {
    id: 'Hourglass',
    name: 'Held Breath',
    ...
    element: 'air',
    what: 'A belly held permanently tight, so the breath happens in the chest and the ribs flare instead of widening.',
    cause:
      'Holding your stomach in, for long enough that you forgot you were doing it.',
    costs:
      'You cannot relax what you never stop clenching, and the diaphragm never gets its full range.',
    target: 'Hourglass',
    times: 20,
    withinDays: 28,
    tell: 'Lie down, hand on your belly. If it does not rise before your chest does, this is yours.',
  },
];
